...
def test_extract_posts_comprehensive():
    ...
    assert isinstance(result, list), 'Ожидаемый тип данных: список'
    ...
    assert (all(isinstance(post['text'], str) for post in result)), "Все элементы ['text'] должны быть строками"
